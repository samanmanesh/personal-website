const HilarionData = {
  ...
  paragraphs: [
    ...
    "For the backend, I utilized <a href='https://www.mongodb.com/' target='_blank'>MongoDB</a> for efficient data management and structured storage, and <a href='https://nodejs.org/en' target='_blank'>Node.js</a> to handle API requests and server-side operations. To enhance security, I implemented <b>SHA256 hashing</b> with salting using <a href='https://www.npmjs.com/package/bcrypt' target='_blank'>Bcrypt</a> library, ensuring that user passwords and sensitive data remain protected. Additionally, robust authentication mechanisms were incorporated to manage user sessions, logins, and access rights securely.",
